...
m.reply(`🚫 *ESTÁ BANEADO(A), NO PUEDE USAR LOS COMANDOS*\n📑 *MOTIVO: ${user.messageSpam === 0 ? 'NO ESPECIFICADO' : user.messageSpam}*\n⚠️ \`\`\`SI ESTE BOT ES CUENTA OFICIAL Y TIENE EVIDENCIA QUE RESPALDE QUE ESTE MENSAJE ES UN ERROR, PUEDE EXPONER SU CASO EN:\`\`\`👉 *_${ig}_*\n👉 *_${asistencia}_*`)
user.antispam++	
return
}
...
this.sendMessage(m.chat, {text: `𝙐𝙎𝙏𝙀𝘿 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀 𝘼𝙑𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝘈𝘷𝘦𝘳𝘯𝘶𝘴𝘉𝘰𝘵-𝘔𝘋 - 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱𝘉𝘰𝘵 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝘈𝘷𝘦𝘳𝘯𝘶𝘴𝘉𝘰𝘵-𝘔𝘋 - 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱𝘉𝘰𝘵 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + ' AVCOINS USADOS EN ESTA FUNCION')  
break
}}} catch (e) {
console.error(e)
} finally {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝘈𝘷𝘦𝘳𝘯𝘶𝘴𝘉𝘰𝘵-𝘔𝘋 - 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱𝘉𝘰𝘵') :
...
"thumbnail": apii.data, 
"title": [wm, '𝘈𝘷𝘦𝘳𝘯𝘶𝘴𝘉𝘰𝘵-𝘔𝘋 - 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱𝘉𝘰𝘵', 'avernusbotwa@gmail.com'].getRandom(),
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '𝘈𝘷𝘦𝘳𝘯𝘶𝘴𝘉𝘰𝘵-𝘔𝘋 - 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱𝘉𝘰𝘵', 'avernusbotwa.gmail.com'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
