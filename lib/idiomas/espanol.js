...
const smsRowner = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖 𝘔𝘐 𝘊𝘙𝘌𝘈𝘋𝘖𝘙 𝘖 𝘠𝘖 𝘗𝘜𝘌𝘋𝘌 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘙` }//NUMERO DE BOT
const smsOwner = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖 𝘔𝘐 𝘗𝘙𝘖𝘗𝘐𝘌𝘛𝘈𝘙𝘐𝘖 𝘓𝘖 𝘗𝘜𝘌𝘋𝘖 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘙` }//OWNER
const smsMods = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖𝘚 𝘓𝘖𝘚 𝘔𝘖𝘋𝘌𝘙𝘈𝘋𝘖𝘙𝘌𝘚 𝘠 𝘌𝘓 𝘊𝘙𝘌𝘈𝘋𝘖𝘙 𝘋𝘌𝘓 𝘉𝘖𝘛 𝘓𝘖 𝘗𝘜𝘌𝘋𝘌 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘙` }//MODERADORES
const smsPremium = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘌𝘚𝘛𝘈 𝘋𝘐𝘚𝘗𝘖𝘕𝘐𝘉𝘓𝘌 𝘗𝘈𝘙𝘈 𝘜𝘚𝘜𝘈𝘙𝘐𝘖𝘚 𝘗𝘙𝘖 𝘖 𝘔𝘐 𝘗𝘙𝘖𝘗𝘐𝘌𝘛𝘈𝘙𝘐𝘖` }//USUARIOS PREMIUM
const smsGroup = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘚𝘖𝘓𝘖 𝘌𝘚 𝘗𝘖𝘚𝘐𝘉𝘓𝘌 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘙𝘓𝘖 𝘌𝘕 𝘎𝘙𝘜𝘗𝘖𝘚` }//PARA GRUPOS
const smsPrivate = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘌𝘚 𝘚𝘖𝘓𝘖 𝘜𝘛𝘐𝘓𝘐𝘡𝘈𝘉𝘓𝘌 𝘌𝘕 𝘌𝘓 𝘊𝘏𝘈𝘛 𝘗𝘙𝘐𝘝𝘈𝘋𝘖` }//AL PRIVADO
const smsAdmin = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘌𝘚𝘛𝘈 𝘚𝘖𝘓𝘈𝘔𝘌𝘕𝘛𝘌 𝘋𝘐𝘚𝘗𝘖𝘕𝘐𝘉𝘓𝘌 𝘗𝘈𝘙𝘈 𝘓𝘖𝘚 𝘈𝘋𝘔𝘐𝘕𝘐𝘚𝘛𝘙𝘈𝘋𝘖𝘙𝘌𝘚` }//ADMINS
const smsBotAdmin = () => { return `𝘕𝘌𝘊𝘌𝘚𝘐𝘛𝘖 𝘚𝘌𝘙 𝘈𝘋𝘔𝘐𝘕𝘐𝘚𝘛𝘙𝘈𝘋𝘖𝘙 𝘋𝘌 𝘌𝘚𝘛𝘌 𝘎𝘙𝘜𝘗𝘖 𝘗𝘈𝘙𝘈 𝘙𝘌𝘈𝘓𝘐𝘡𝘈𝘙 𝘌𝘚𝘛𝘈 𝘍𝘜𝘕𝘊𝘐𝘖𝘕` }//BOT CON ADMIN
const smsUnreg = () => { return `𝘗𝘈𝘙𝘈 𝘜𝘚𝘈𝘙 𝘌𝘚𝘛𝘈 𝘍𝘜𝘕𝘊𝘐𝘖𝘕 𝘖 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘋𝘌𝘉𝘌𝘚 𝘌𝘚𝘛𝘈𝘙 𝘙𝘌𝘎𝘐𝘚𝘛𝘙𝘈𝘋𝘖` }//VERIFICAR
const smsRestrict = () => { return `𝘌𝘚𝘛𝘌 𝘊𝘖𝘔𝘈𝘕𝘋𝘖 𝘍𝘜𝘌 𝘙𝘌𝘚𝘛𝘙𝘐𝘕𝘎𝘐𝘋𝘖 𝘗𝘖𝘙 𝘔𝘐 𝘊𝘙𝘌𝘈𝘋𝘖𝘙 𝘖 𝘗𝘙𝘖𝘗𝘐𝘌𝘛𝘈𝘙𝘐𝘖` }//RESTRINGIR COMANDO
