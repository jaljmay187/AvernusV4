    ...
    return await conn.sendMessage(jid, {
      ...
      ...options
        ...
        reply: {
             ...
             * @param {Object} options
             */
            value(jid, text = '', quoted, options) {                           return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: null, forwardedNewsletterMessageInfo: { newsletterJid: ["12036329301542590@newsletter", "120363312848678787@newsletter", "1203663311153527781@newsletter"].getRandom(), serverMessageId: '', newsletterName: wm }, forwardingScore: 9999999, isForwarded: true, ...options }}, { quoted, ...options })
            }
        },
